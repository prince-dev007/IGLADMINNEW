...
function rawTimeStamp(dateTime = new Date(), type = '') {
    ...
    if (!type)
        return dateObject.year + '-' + dateObject.month + '-' + dateObject.day + ' ' + dateObject.hours + ':' + dateObject.mins + ':' + dateObject.secs;
    else
        return dateObject.year + '' + dateObject.month + '' + dateObject.day + '' + dateObject.hours + '' + dateObject.mins + '' + dateObject.secs + '' + dateObject.miliSecs;
}
